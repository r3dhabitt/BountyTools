...
As ferramentas em go é indicado fazer: mv /root/go/bin/nome ferramenta para: /usr/bin
...
Esta é a ferramenta CLI para envio rápido de múltiplas solicitações HTTP.
